...
export default tseslint.config(
  ...
  // Generated by `supabase gen types`; regenerated whenever schema changes.
  { ignores: ["src/db/database.types.ts"] },
  // Claude Code tooling: standalone Node hook scripts + agent worktrees, not part
  // of any tsconfig — the typed parser (projectService) errors on them otherwise.
  { ignores: [".claude/**"] },
  baseConfig,
  reactConfig,
